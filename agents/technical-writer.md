...
- **MCP docs tools** (`mcp_*-docs_*`): Use for any library-specific documentation (LangChain, OpenAI, FastMCP, etc.)
- **Context7** (`mcp_context7_*`): For general library docs — resolve library ID first, then query
- **Web search**: For documentation best practices, style guides, and tooling
