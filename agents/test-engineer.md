...
- Use `mcp_*-docs_*` tools for framework-specific testing patterns
- Use `mcp_context7_*` for pytest, hypothesis, pytest-asyncio docs
- Search web for testing patterns specific to the libraries in use
...
3. **Ask before writing** — Your `edit: ask` permission means you propose
...
- `mcp_mem0_search_memories("testing patterns for {project}")` 
- `mcp_mem0_search_memories("flaky tests {area}")`
